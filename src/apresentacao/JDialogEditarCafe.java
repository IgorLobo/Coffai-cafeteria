 ...
 * @author Igor Lobo
 */
public class JDialogEditarCafe extends javax.swing.JDialog {

    public static FrmCadCafe telaPai;

    public JDialogEditarCafe(FrmCadCafe parent, boolean modal) {
        this.telaPai = parent;
        this.setModal(modal);
        initComponents();
        carregarTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogEditarCafe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogEditarCafe dialog = new JDialogEditarCafe(telaPai, true);
